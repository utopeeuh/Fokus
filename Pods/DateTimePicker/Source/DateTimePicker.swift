...
@objc public class DateTimePicker: UIView {
    ...
    private func configureView() {
        ...
        // done button
        doneButton.setTitle(doneButtonTitle, for: .normal)
        doneButton.setTitleColor(UIColor(red: 0, green: 172/255, blue: 141/255, alpha: 1), for: .normal)
        doneButton.backgroundColor = .clear
        doneButton.titleLabel?.font = customFontSetting.doneButtonFont
        doneButton.layer.cornerRadius = 8
        doneButton.layer.borderWidth = 1
        doneButton.layer.borderColor = UIColor(red: 0, green: 172/255, blue: 141/255, alpha: 1).cgColor
